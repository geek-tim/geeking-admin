...
<template>
    <n-card title="字典示例">
        <n-flex vertical>
            ...
            <n-flex>
                <n-button @click="getDict"> 获取当前字典数据 </n-button>
                <n-button @click="getEnum"> 获取当前字典枚举 </n-button>
                <n-button @click="getValueMap"> 获取当前字典ValueMap </n-button>
                <n-button @click="getLabelMap"> 获取当前字典LabelMap </n-button>
            </n-flex>
          ...
          {{ data }}
            ...
            <n-flex align="center">
                ...
                <n-text type="info"> Map回显结果 {{ dictLabel }} </n-text>
            </n-flex>
            <n-flex align="center">
                <n-input-number v-model:value="enumValue" :min="0" />
                <n-text type="info"> Enum回显结果 {{ enumLabel }} </n-text>
            </n-flex>
        </n-flex>
    </n-card>
</template>
