        ...
        >
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    <h1
                        class="text-5xl md:text-7xl font-extrabold text-gray-900 mb-8 leading-tight"
                    >
                        现代化的
                        <span
                    ...
                    >
                        <button
                            class="text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transition-all transform hover:scale-105"
                            style="
                                background: linear-gradient(
                                    to right,
                                    #56cb46,
                        ...
                        <button
                            class="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-full text-lg font-semibold hover:border-gray-400 transition-colors"
                        >
                            查看演示
                        </button>
                    </div>
                ...
                <div class="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div class="text-center">
                        ...
                        <div class="text-gray-600">项目部署</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-bold text-gray-900 mb-2">
                            {{ animatedStats.components }}+
                        </div>
                        <div class="text-gray-600">组件库</div>
                    </div>
                    <div class="text-center">
                        <div class="text-4xl font-bold text-gray-900 mb-2">
                            99.9%
                        </div>
                        <div class="text-gray-600">稳定性</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="features" class="py-24 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div
                            class="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center mb-6"
                        >
                            <svg
                    ...
                    >
                        <div
                            class="w-12 h-12 bg-indigo-100 rounded-xl flex items-center justify-center mb-6"
                        >
                            <svg
                    ...
                    >
                        <div
                            class="w-12 h-12 bg-pink-100 rounded-xl flex items-center justify-center mb-6"
                        >
                            <svg
                    ...
                    <div class="space-y-8">
                        <div class="bg-gray-50 rounded-2xl p-8">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <div
                                    class="bg-white rounded-lg p-4 text-center"
                                >
                                    <div
                            ...
                            <button
                                ...
                                "
                                onmouseout="
                                    this.style.backgroundColor = '#56CB46'
                                "
                                @click="refreshData"
                            >
                                刷新数据
