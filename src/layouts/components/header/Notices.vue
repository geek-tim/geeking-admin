...
const MassageData = ref<Entity.Message[]>([
    ...
    },
    {
        id: 3,
        type: 0,
        title: 'Admin 已经添加菜单导航功能！Admin 已经添加菜单导航功能！Admin 已经添加菜单导航功能！Admin 已经添加菜单导航功能！',
        icon: 'icon-park-outline:tips-one',
        tagTitle: '未开始',
        tagType: 'error',
        description:
                ...
                <template #tab>
                    <n-space class="w-130px" justify="center">
                        ...
                        <n-badge
                            type="info"
                            :value="
                                groupMessage[0]?.filter((i) => !i.isRead).length
                            "
                            :max="99"
                        />
                    </n-space>
                ...
                <template #tab>
                    <n-space class="w-130px" justify="center">
                        ...
                        <n-badge
                            type="warning"
                            :value="
                                groupMessage[1]?.filter((i) => !i.isRead).length
                            "
                            :max="99"
                        />
                    </n-space>
                ...
                <template #tab>
                    <n-space class="w-130px" justify="center">
                        ...
                        <n-badge
                            type="error"
                            :value="
                                groupMessage[2]?.filter((i) => !i.isRead).length
                            "
                            :max="99"
                        />
                    </n-space>
