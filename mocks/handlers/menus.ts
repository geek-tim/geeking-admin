...
export const allmenus = [
    ...
    },
    {
        ...
        icon: 'carbon:error',
        order: 3,
        componentPath: '/build-in/exception/403.vue',
        id: 32,
        pid: 31,
    },
    {
        ...
        order: 2,
        componentPath: '/build-in/exception/404.vue',
        id: 33,
        pid: 31,
    },
    {
        ...
        order: 1,
        componentPath: '/build-in/exception/500.vue',
        id: 34,
        pid: 31,
    },
    {
...
const menuManager = new MockDataManager('mock_menus', allmenus)

export const menus = [
    request.get('/api/menus', {
        total: 50,
        list: menuManager.getAll(),
    }),
    request.delete('/api/menus/:id', menuManager),
]
